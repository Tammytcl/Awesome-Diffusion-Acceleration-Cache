...
| Publication Date | Conference/Journal | Method Name | Paper Title | Institution | Paper Link | Code Repository |
|------------------|-------------------|-------------|-------------|-------------|------------|-----------------|
| 2023.05 | AAAI 2024 | FISEdit | Accelerating Text-to-Image Editing via Cache-Enabled Sparse Diffusion Inference | Peking University | [Paper](https://arxiv.org/pdf/2305.17423) | [Code](https://github.com/Hankpipi/diffusers-hetu) |
| 2023.12 | - | DeepCache | DeepCache: Accelerating Diffusion Models for Free | National University of Singapore | [Paper](https://arxiv.org/pdf/2312.00858) | [Code](https://github.com/horseee/DeepCache) |
| 2023.12 | - | Block Caching | Cache Me if You Can: Accelerating Diffusion Models through Block Caching | Meta GenAI | [Paper](https://arxiv.org/pdf/2312.03209) | - |
...
| 2024.06 | - | ∆-DiT | ∆-DiT: A Training-Free Acceleration Method Tailored for Diffusion Transformers | Fudan | [Paper](https://arxiv.org/pdf/2406.01125) | - |
...
| 2024.07 | - | FORA | FORA: Fast-Forward Caching in Diffusion Transformer Acceleration | Microsoft | [Paper](https://arxiv.org/pdf/2407.01425) | [Code](https://github.com/prathebaselva/FORA) |
...
| 2024.11 | - | AdaCache | Adaptive Caching for Faster Video Generation with Diffusion Transformers | Meta | [Paper](https://adacache-dit.github.io/clarity/adacache_meta.pdf) | [Code](https://github.com/AdaCache-DiT/AdaCache) |
| 2024.11 | CVPR 2025 | TeaCache | Timestep Embedding Tells: It's Time to Cache for Video Diffusion Model | Alibaba | [Paper](https://arxiv.org/pdf/2411.19108) | [Code](https://github.com/LiewFeng/TeaCache) |
| 2024.11 | - | LazyDiT | LazyDiT: Lazy Learning for the Acceleration of Diffusion Transformers | Adobe Research | [Paper](https://arxiv.org/pdf/2412.12444) | - |
